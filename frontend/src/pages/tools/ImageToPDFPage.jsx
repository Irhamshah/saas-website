// src/pages/tools/ImageToPDFPage.jsx
...
function ImageToPDFPage() {
  ...
  return (
    <div className="tool-page-with-ads">
      <SEO
        title="Image to PDF Converter - Convert Images to PDF | LiteTools"
        description="Convert multiple images to a single PDF document online for free. Supports JPG, PNG, WebP and more. Fast, secure, and easy to use."
      ...
      <div className="tool-page">
        ...
        <div className="tool-header">
          <button className="back-button" onClick={() => navigate('/image-tools')}>
            <ArrowLeft size={20} />
        ...
        <div className="tool-content">
          ...
          >
            ...
            <p className="file-info">Multiple images • Drag to reorder</p>
          </div>
        ...
        <div className="tool-features">
          ...
          <div className="features-grid">
            ...
            <div className="feature-item">
              ...
              <strong>Custom Page Sizes</strong>
              <p>Choose A4, Letter, or fit to image</p>
            </div>
            <div className="feature-item">
              <div className="feature-icon">🔀</div>
              <strong>Drag & Drop</strong>
              <p>Easily reorder images before conversion</p>
            </div>
            <div className="feature-item">
              <div className="feature-icon">🔒</div>
