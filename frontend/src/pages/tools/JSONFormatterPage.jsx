...
function JSONFormatterPage() {
  ...
  return (
    <div className="tool-page-with-ads">
      <SEO
        title="JSON Formatter - Format, Validate & Beautify JSON | LiteTools"
        description="Free online JSON formatter and validator. Format, beautify, minify, and validate JSON data. Sort keys and view statistics."
        ...
        <div className="tool-features">
          ...
          <div className="features-grid">
            <div className="feature-item">
              ...
              <p>Make JSON readable with proper indentation</p>
            </div>
            <div className="feature-item">
              <div className="feature-icon">🗜️</div>
              <strong>Minify</strong>
              <p>Remove whitespace to reduce file size</p>
            </div>
            <div className="feature-item">
              <div className="feature-icon">✓</div>
              <strong>Validate</strong>
              <p>Check if JSON syntax is correct</p>
            </div>
            <div className="feature-item">
              <div className="feature-icon">🔤</div>
              <strong>Sort Keys</strong>
              <p>Alphabetically sort object keys</p>
            </div>
          </div>
        </div>
